...
// ISO 3166-1 alpha-2 -> 3-letter code used on tour (IOC/ITF style) for a clean,
// emoji-free country badge.
const COUNTRY_CODES = {
  IT: "ITA", ES: "ESP", DE: "GER", GB: "GBR", US: "USA", RS: "SRB",
  DK: "DEN", RU: "RUS", AU: "AUS", NO: "NOR", GR: "GRE", PL: "POL",
  BG: "BUL", AR: "ARG", FR: "FRA", BR: "BRA", CZ: "CZE", BY: "BLR",
  CN: "CHN", KZ: "KAZ", LV: "LAT", CA: "CAN", HR: "CRO", UA: "UKR",
};
